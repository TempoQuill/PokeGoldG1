...
; entries correspond to TX_* constants (see macros/scripts/text.asm)
	...
	dw TextCommand_SOUND         ; TX_SOUND_TM
	dw TextCommand_SOUND         ; TX_SOUND_ITEM
	dw TextCommand_SOUND         ; TX_SOUND_EVO_DITTY
	dw TextCommand_SOUND         ; TX_SOUND_SPECIAL_ITEM
...
TextSFX::
	...
	dbw TX_SOUND_TM,                 SFX_TM
	dbw TX_SOUND_ITEM,               SFX_ITEM
	dbw TX_SOUND_EVO_DITTY,          SFX_EVO_DITTY
	dbw TX_SOUND_SPECIAL_ITEM,       SFX_SPECIAL_ITEM
